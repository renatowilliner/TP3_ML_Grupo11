...
│   └─ EDA.ipynb              # Notebook con análisis exploratorio: visualizaciones, estadísticas, detección de outliers
├─ features/
│   └─ create_features.py     # Funciones o notebook para generar nuevas features: lag features, rolling stats, indicadores técnicos
├─ experiments/
│   ├─ baseline.ipynb         # Experimentos con modelos simples de baseline (predicción naive, etc.)
│   ├─ xgboost_experiment.ipynb # Experimentos con modelo XGBoost
...
├─ src/
│   ├─ data.py                # Funciones para carga de datos y splits (train/test/validation)
...
└─ memoria_TP_ML_grupo_X.pdf # Memoria técnica final con decisiones, metodología y conclusiones
